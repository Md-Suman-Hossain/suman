...
# --- CONFIGURATION ---
TOKEN = "8818291059:AAFNUgUpv80nQrVeht9g8zgBU8M10jhfTTE"  
ADMIN_ID = 7878473793
...
PREMIUM_FLAGS = {
    ...
    "djibouti": "5911407709915190157", "denmark": "5911206009661034712", "cyprus": "5911023550860366409", "croatia": "5913692684056269311", "costa rica": "5911261745451635030", "congo": "5911338788574990168", "congo, the democratic republic of the": "5913770362834783827", "democratic republic of the congo": "5913770362834783827",
    "comoros": "5911338582416560604", "cambodia": "5913699998385573485", "cameroon": "5911172109484167745", "canada": "5913623736946265914", "cape verde": "5913571501554012193", "central african republic": "5913443245240619222",
...
def fetch_real_numbers(chat_id, srv_id, cnt_id, msg_id, custom_range=None):
    ...
    api_url = data.get("api_url", DEFAULT_BASE_URL)
...
def show_admin_panel(chat_id, message_id=None):
    ...
    markup.add(
        ibtn("SET API KEY", "admin_api", style="danger", custom_emoji_id=get_emoji_id("emj_key")),  
    ...
    try:
        ...
        if res.status_code == 200:
            ...
            api_msg = (
                ...
                f"▫️ <b>Endpoint URL:</b> <code>{api_url}</code>\n"
    ...
    try:
        ...
        # Withdrawal smart system handlers
            ...
            if not data.get("settings", {}).get("withdraw_enabled", True):
                # দ্বিতীয় ছবির হুবহু মেসেজটি চ্যাটে পাঠানো হবে
                wd_off_msg = (
        ...
        # Admin callbacks
            ...
            data = load_data()
            old_url = data.get("api_url", DEFAULT_BASE_URL)
            active_id = admin_active_menus.get(str(chat_id))
            text = f"📌 <b>Current Base URL:</b> <code>{old_url}</code>\n\n🔗 Send your new API Base URL below:"
